...
TTLine {
    ...
    */
    neighbor { |articulationIndex, up, interval|
        ...
        // TODO: LEFT OFF - don't have a way to apply interval to a note
//        var neighborNote = if (up, { articulationNote1.
//        lineNotes.insert(articulationIndex + 1, 
    }
